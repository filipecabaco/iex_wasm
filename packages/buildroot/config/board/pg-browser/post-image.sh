...
chown -R 100:101 rootfs/var/lib/eex
chown -R 100:101 rootfs/var/lib/elixir
chown -R 100:101 rootfs/var/lib/ex_unit
chown -R 100:101 rootfs/var/lib/iex
chown -R 100:101 rootfs/var/lib/logger
chown -R 100:101 rootfs/var/lib/mix

# Make the folder executable for pg_ctl
chmod 700 rootfs/var/lib/eex
chmod 700 rootfs/var/lib/elixir
chmod 700 rootfs/var/lib/ex_unit
chmod 700 rootfs/var/lib/iex
chmod 700 rootfs/var/lib/logger
chmod 700 rootfs/var/lib/mix
