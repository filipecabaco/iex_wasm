...
[DEFINED] float [IF]
    ...
    FLOAT ARRAY REL-NEAR 1 S>F 1000000 S>F FDUP F* F/ REL-NEAR F!
    FLOAT ARRAY ABS-NEAR 0 S>F ABS-NEAR F!
...
[UNDEFINED] ZenFP [DEFINED] float * [IF]
    VARIABLE ACTUAL-FDEPTH
    32 FLOATS ARRAY ACTUAL-FRESULTS
...
[ELSE]
    ...
    : COMPUTE-CELLS-PER-FP ( -- U )
        DEPTH 0 S>F DEPTH 1- >R FDROP R> SWAP - ;

    COMPUTE-CELLS-PER-FP VALUE CELLS-PER-FP
