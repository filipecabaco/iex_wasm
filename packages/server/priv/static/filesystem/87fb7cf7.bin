\ 4tH library - ISO 8859-1 to HTML codes - Copyright 2012 J.L. Bezemer
\ You can redistribute this file and/or modify it under
\ the terms of the GNU General Public License

[UNDEFINED] ISO8859>HTML       [IF]
[UNDEFINED] CP437|ISO8859|HTML [IF] [ABORT]             [THEN]
[UNDEFINED] row                [IF] [needs lib/row.4th] [THEN]

aka CP437|ISO8859|HTML ISO8859>HTML
does>                                  ( c -- a n)
  over if
    cell+ 3 num-key row                \ search table
